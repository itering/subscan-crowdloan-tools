<template>
  <div class="metadata-wrapper subscan-card">
    ...
    <div class="count">
      <router-link tag="div" class="count-item" to="/parachain?tab=parachain">
        <div class="content">
      ...
      <router-link tag="div" class="count-item" to="/parachain?tab=upcoming">
        <div class="content">
          <div class="name">{{$t('parachain.upcoming')}}</div>
          <div class="number">{{parachainMetadata.upcoming_count}}</div>
        </div>
      </router-link>
      <router-link tag="div" class="count-item" to="/auction_board">
        <div class="content">
